...
class EWUserDetailChild extends EWUserDetail
{
    protected $casts = [
    ...
    protected $fillable = ['user_id', 'gender', 'date_of_birth', 'nid_number', 'id_card_image', 'selfie_image', 'status', 'step', 'comment', 'city_id', 'country_id', 'is_synchronized', 'organization_ref_id', 'user_ref_id', 'role_ref_id', 'created_by', 'updated_by'];
     ...
     * Get the user that owns the Profile.
     */
    public function user_registration_step()
    {
        return $this->belongsTo('App\Models\EWUserRegistrationStep', 'user_id', 'id');
    }
